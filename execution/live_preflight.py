...
def main() -> int:
    ...
    p.add_argument("--min-orderable-cash", type=int, default=300000)
    ...
    if cash is None or cash < args.min_orderable_cash:
        reasons.append(
            f"ORDERABLE_CASH_BELOW_PREFLIGHT_MIN({cash}<{args.min_orderable_cash})"
        )
    ...
    print(f"required_min_orderable_cash={args.min_orderable_cash}")
